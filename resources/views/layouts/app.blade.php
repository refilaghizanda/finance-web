			...
			<div class="sidebar-wrapper active">
				<div class="sidebar-header position-relative">
					<div class="d-flex justify-content-between align-items-center">
						<div class="logo">
							<a href="{{ route('dashboard') }}">Finance</a>
						</div>
				...
				<div class="sidebar-menu">
					<ul class="menu">
						...
						{{-- <li class="sidebar-title text-muted"><i class="bi bi-menu-button-wide"></i></li> --}}
						...
						<li
							...
							<ul class="submenu">
								<li class="submenu-item {{ request()->routeIs('cash-transactions.index') ? 'active' : '' }}">
									<a href="{{ route('cash-transactions.index') }}" class="submenu-link">Kas Kecil</a>
								</li>

								<li class="submenu-item {{ request()->routeIs('cash-transactions.filter.index') ? 'active' : '' }}">
									<a href="{{ route('cash-transactions.filter.index') }}" class="submenu-link">Kas Besar</a>
								</li>
							</ul>
						</li>
